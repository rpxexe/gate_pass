                ...
                <div class="card border-0 shadow-lg my-5">
                    ...
                    <form action="{{ route('data.store') }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('asset') }}" name="asset" id="" class="@error('asset') is-invalid @enderror form-control form-control-lg">
                            @error('asset')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" value="{{ old('person') }}" name="person" id="" class=" @error('person') is-invalid @enderror form-control form-control-lg">
                            @error('person')
                                <p class="invalid-feedback">{{ $message }}</p>
                            @enderror
                        </div>
